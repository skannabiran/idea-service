package com.maveric.techhub.idea;

import com.maveric.techhub.idea.config.AppConstants;
import com.maveric.techhub.idea.config.ApplicationProperties;
import com.maveric.techhub.idea.config.DefaultProfileUtil;
...
public class IdeaServiceApplication {
	private static final Logger log = LoggerFactory.getLogger(IdeaServiceApplication.class);
	private final Environment env;

	public IdeaServiceApplication(Environment env) {
		this.env = env;
	}
	...
	public static void main(String[] args) throws UnknownHostException {
		SpringApplication app = new SpringApplication(IdeaServiceApplication.class);
